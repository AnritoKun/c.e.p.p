window.addEventListener("message", function (e) {
	...
	video_m3u8 = '#EXTM3U' +
		...
		'\n' + video_m3u8_array[0] +
		'\n#EXT-X-STREAM-INF:PROGRAM-ID=1,BANDWIDTH=8098235,RESOLUTION=1920x1080,FRAME-RATE=23.974,CODECS="avc1.640028,mp4a.40.2"' +window.addEventListener("message", function (e) {window.addEventListener("message", function (e) {
